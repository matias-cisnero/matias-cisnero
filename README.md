...
💻 **Python Developer** with an **Associate Degree in Artificial Intelligence** from **UNAHUR**.  
📚 Specialized in **Machine Learning** and **Deep Learning**, with expertise in **Computer Vision** and **Natural Language Processing (NLP)**.
